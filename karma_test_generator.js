...
const fixture_dirs = ['spec/compiled_fixtures/', 'spec/compiled_fixtures/includes/'];
const test_dir = 'spec/karma_env/';
const src_dirs = ['src/javascripts/'];//, 'src/javascripts/concat/'];
const output_dir = 'spec/tmp/';
...
* associated src .js file. This tmp file is loaded into the browser by Karma.
*/
